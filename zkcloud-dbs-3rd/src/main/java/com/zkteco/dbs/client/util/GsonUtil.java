package com.zkteco.dbs.client.util;
...
public class GsonUtil {
    ...
    public static String toJson(Object target, Type targetType,
        ...
        String result = EMPTY;
        Gson gson = builder.disableHtmlEscaping().setDateFormat(datePattern).create();
        try {
            if (targetType != null) {
    ...
    public static <T> T fromJson(String json, TypeToken<T> token, String datePattern) {
        ...
        Gson gson = builder.setDateFormat(datePattern).registerTypeAdapter(HashMap.class, new JsonDeserializer<HashMap>() {
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        Gson gson = builder.setDateFormat(datePattern)
