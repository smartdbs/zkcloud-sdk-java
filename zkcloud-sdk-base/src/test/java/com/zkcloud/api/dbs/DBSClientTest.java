...
public class DBSClientTest {
    ...
    //    String endpoint = "smartdbs-api.zkclouds.com";
    String endpoint = "127.0.0.1:18801";
    String appKey = "364edb6115af4e5191799c2fe2f55f4b";
    String appSecret = "ef68339356614987946235091097ee60";
    DBSClient client;

    String defaultCompanyCode = "door";
    String defaultCompanyName = "door";
    String defaultCompanyEmail = "door@qq.com";
    String defaultCompanyApiUsername = "door@qq.com";
    String defaultCompanyApiPassword = "123456";
    ...
    public void testUpdateEmployee() throws Exception {
        EmployeeUpdateRequest employee = new EmployeeUpdateRequest("2956", "Huiwu", "Lin");
    ...
    public void testUpdateEmployeeBatch() throws Exception {
        ...
        for (int i = 1000; i < 1050; i++) {
            EmployeeUpdateRequest emp = new EmployeeUpdateRequest(i + "", "luther", "Lin" + i);
    ...
    public void testQueryVerifyInfo() throws Exception {
        VerifyInfoRequest verifyInfoRequest = new VerifyInfoRequest("2956");
    ...
    public void testVerifyInfoByEmployee() throws Exception {
        VerifyInfoByEmployeeRequest verifyInfoByEmployeeRequest = new VerifyInfoByEmployeeRequest("29562", "3379163000027", 1, 10);
    ...
    public void queryEmployeeFace() throws ZKCloudSDKException {
        ...
        Message response = client.queryEmployeeFace(employeeFaceRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true, ErrorCode.CODE_SUCCESS.equals(response.getCode()));
    }
    ...
    public void registerBiometric() throws Exception {
        ...
        Message response = client.registerBiometric(registerBiometricRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true,
                ErrorCode.CODE_SUCCESS.equals(response.getCode()) || "E0010055".equals(response.getCode()) || "E0010042".equals(response.getCode())
                        || "E0010074".equals(response.getCode()) || "E0010075".equals(response.getCode()));
    ...
    public void commandListByPage() throws Exception {
        CommandListByPageRequest commandListByPageRequest = new CommandListByPageRequest("3379163000027", 1604073600L, 1606320000L, "1", 1, 10);
        commandListByPageRequest.setApiUser(new User(defaultCompanyApiUsername, defaultCompanyApiPassword));
        Message response = client.commandListByPage(commandListByPageRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true,
                ErrorCode.CODE_SUCCESS.equals(response.getCode()) || "E0010055".equals(response.getCode()) || "E0010042".equals(response.getCode())
                        || "E0010074".equals(response.getCode()) || "E0010075".equals(response.getCode()));
    ...
    public void testOrgBindDevice() throws Exception {
        ...
        Message response = client.orgBindDevice(orgBindDeviceRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true,
    ...
    public void testOrgUnBindDevice() throws Exception {
        ...
        Message response = client.orgUnBindDevice(orgUnbindDeviceRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true,
                ErrorCode.CODE_SUCCESS.equals(response.getCode()) || "E0010042".equals(response.getCode()) || "E0010021".equals(response.getCode()));
    }
    ...
    public void testEmployeeBindDevice() throws Exception {
        ...
        Message response = client.employeeBindDevice(employeeBindDeviceRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true,
    ...
    public void testEmployeeUnBindDevice() throws Exception {
        ...
        Message response = client.employeeUnBindDevice(employeeUnbindDeviceRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true,
                ErrorCode.CODE_SUCCESS.equals(response.getCode()) || "E0010042".equals(response.getCode()) || "E0010041".equals(response.getCode()));
    }
    ...
    public void testUpdateDoor() throws Exception {
        PunchRecordVerifyRequest punchRecordRequest = new PunchRecordVerifyRequest(1585670400L, 1588089599L);
...
//        doorQueryRequest.setDoorNum(1);
    ...
    public void testUpdateDoorParam() throws Exception {
        ...
        doorQueryRequest.setApiUser(new User(defaultCompanyApiUsername, defaultCompanyApiPassword));
        Message<List<DoorQueryResponse>> response = client.updateDoorParam(doorQueryRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true, ErrorCode.CODE_SUCCESS.equals(response.getCode()));
    }
    ...
    public void testUpdateDoorTimeZone() throws Exception {
        ...
        DoorTimeZoneUpdateRequest timeZoneUpdateRequest = new DoorTimeZoneUpdateRequest(200, "星期一", 0, list);
    ...
    public void testDoorPermissionGroupAddDoor() throws Exception {
        DoorPermissionGroupAddDoorRequest doorPermissionGroupDeleteRequest = new DoorPermissionGroupAddDoorRequest(200, Arrays.asList(new DoorPermissionGroupAddDoorDevice("6073202900002", Arrays.asList(1))));
        doorPermissionGroupDeleteRequest.setApiUser(new User(defaultCompanyApiUsername, defaultCompanyApiPassword));
    ...
    public void testGetTransactionRecord() throws Exception {
        ...
        Message response = client.getTransactionRecord(doorTransactionRecordRequest);
        System.err.println(JSONUtil.toJsonPrettyStr(response));
        Assert.assertEquals(response.getMessage(), true, ErrorCode.CODE_SUCCESS.equals(response.getCode()));
    }
    ...
    @Test
    public void getPunchRecordByPage() throws Exception {
