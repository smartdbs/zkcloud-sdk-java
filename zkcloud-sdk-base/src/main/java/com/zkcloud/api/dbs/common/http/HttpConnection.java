...
package com.zkcloud.api.dbs.common.http;
...
//        this.client.setWriteTimeout(writeTimeout, TimeUnit.SECONDS);
    ...
    public Response doRequest(Request request) throws ZKCloudSDKException {
        Response response = null;
        try {
            response = this.client.newCall(request).execute();
        } catch (IOException e) {
            throw new ZKCloudSDKException(e.getClass().getName() + "-" + e.getMessage());
        }
        return response;
    }

    public Response getRequest(String url) throws ZKCloudSDKException {
    ...
    public Response getRequest(String url, Headers headers) throws ZKCloudSDKException {
        Request request = null;
        try {
    ...
    public Response postRequest(String url, String body) throws ZKCloudSDKException {
    ...
    public Response postRequest(String url, String body, Headers headers) throws ZKCloudSDKException {
    ...
    public Response postRequest(String url, byte[] body, Headers headers) throws ZKCloudSDKException {
        MediaType contentType = MediaType.parse(headers.get("Content-Type"));
        Request request = null;
        try {
            request = new Request.Builder()
