...
import com.zkteco.dbs.client.model.DoorTransactionRecord;
...
@Component
@Order(1)
@ConditionalOnExpression("${dbs.push.switch.doorTransactionRecord:false}")
public class DoorTransactionRecordProcessor implements DataProcessor {
    ...
    public Message handle(Message request) {
        ...
        // TODO: 门禁事件记录
        logger.debug("DoorTransactionRecordProcessor：" + GsonUtil.toJson(doorTransactionRecords));
